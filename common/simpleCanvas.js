...
var SimpleCanvas = (function () {
    ...
    SimpleCanvas.prototype.drawWrapText = function (layer) {
        var _a = relativePosition.call(this, layer), _b = _a.left, left = _b === void 0 ? 0 : _b, _c = _a.top, top = _c === void 0 ? 0 : _c, _d = _a.text, text = _d === void 0 ? '' : _d, _e = _a.fontSize, fontSize = _e === void 0 ? 12 : _e, _f = _a.width, width = _f === void 0 ? 200 : _f, _g = _a.lineHeight, lineHeight = _g === void 0 ? 1 : _g, _h = _a.color, color = _h === void 0 ? '#333333' : _h;
        var ctx = this.ctx;
        var chr = text.split('');
        var temp = '';
        var row = [];
